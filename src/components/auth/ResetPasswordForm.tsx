...
export default function ResetPasswordForm({ token }: { token: string }) {
    ...
    return (
        <div className="w-full max-w-sm rounded-2xl bg-[#0a101f] border border-blue-900/40 p-8 shadow-[0_0_40px_rgba(30,58,138,0.1)]">
            ...
            <p className="text-gray-400 mb-6 text-sm">Crea tu nueva contraseña para acceder.</p>
            ...
            <form action={handleReset} className="flex flex-col gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-300 mb-1" htmlFor="password">Nueva contraseña</label>
                    <input
                        type="password"
                        id="password"
                        name="password"
