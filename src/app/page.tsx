...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-sans)] bg-black">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start max-w-2xl text-center sm:text-left z-10 w-full">
        <div className="flex flex-col sm:flex-row items-center gap-12 w-full justify-center">
          <div className="flex-1 flex flex-col items-center sm:items-start text-center sm:text-left">
            <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-600 mb-4">
              HR Vacation System
            </h1>
      ...
      <footer className="row-start-3 flex gap-6 flex-wrap items-center justify-center text-sm text-gray-500 z-10">
        &copy; {new Date().getFullYear()} Software Interno. Reservado todos los derechos.
      </footer>
    </div>
  );
}
